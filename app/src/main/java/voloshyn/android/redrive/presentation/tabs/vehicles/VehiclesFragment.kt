...
@AndroidEntryPoint
class VehiclesFragment : Fragment(R.layout.fragment_vehicles),VehiclesAdapter.OnVehicleItemClickListener {
    ...
    override fun onClick(vehicle: Vehicle) {
        Toast.makeText(requireContext(), vehicle.name, Toast.LENGTH_SHORT).show()
    }
