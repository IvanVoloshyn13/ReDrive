...
import com.example.localedatasource.dataStore.SyncMetadataRepositoryImpl
import dagger.Binds
...
interface LocalDataSourceModule {
    ...
    @Binds
    fun bindSyncMetadataRepository(impl: SyncMetadataRepositoryImpl): SyncMetadataRepository
